<template>
  <div class="header-dropdown">
    <div
        class="header-dropdown__selected"
        :class="{ 'open': isHeaderDropdown }"
        @click="isHeaderDropdown = !isHeaderDropdown"
    >
      <div>
        <span v-if="selectedTab === 0" :class="{ 'fill-active': selectedTab === 0 }">
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
            <g clip-path="url(#clip0_671_5509)">
              <path :class="{ 'fill-active': selectedTab === 0 }" d="M9.83508 2.91667H7.00008V0.00933333L9.83508 2.91667ZM5.83341 4.08333V0H2.91675C2.45262 0 2.0075 0.184374 1.67931 0.512563C1.35112 0.840752 1.16675 1.28587 1.16675 1.75V11.0833H9.91675V4.08333H5.83341ZM11.0834 4.08917V12.2722H4.08341V14H12.8334V5.83333L11.0834 4.08917Z" fill="#8CA0B4"/>
            </g>
            <defs>
        ...
        <span v-if="selectedTab === 1" :class="{ 'fill-active': selectedTab === 0 }">
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <span v-if="selectedTab === 2" :class="{ 'fill-active': selectedTab === 0 }">
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <img src="@/assets/svg/arrow-down-blue.svg" alt="">
    </div>
    <div v-if="isHeaderDropdown" class="header-dropdown__list">
      <div
          v-for="tab in tabs"
          :key="tab.id"
          @click="openTab(tab)"
      >
        <button v-if="tab.id !== selectedTab" class="header-dropdown__item">
...
let selected = ref(tabs[0].title)
let isHeaderDropdown = ref(false)

const router = useRouter()

const openTab = (tab: any) => {
  selected.value = tab.title
  selectedTab.value = tab.id
  isHeaderDropdown.value = false
